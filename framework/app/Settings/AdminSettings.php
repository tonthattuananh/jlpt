	...
	public function createAdminOptions()
	{
		add_action('carbon_fields_register_fields', static function () {
			...
			Container::make('theme_options', __('Theme info', 'gaumap'))
					 ...
					 ->add_fields([
						 Field::make('text', 'theme_info_name', __('Tên', 'gaumap'))->set_default_value('NR Global'),
						 Field::make('text', 'theme_info_email', __('Email', 'gaumap'))->set_default_value('info@nrglobal.vn'),
						 Field::make('text', 'theme_info_phone_number', __('Điện thoại', 'gaumap'))->set_default_value('0935 1919 03'),
						 Field::make('text', 'theme_info_logo_url', __('Link logo', 'gaumap'))->set_default_value('https://nrglobal.vn/wp-content/uploads/2018/12/nr-global.gif'),
						 Field::make('text', 'theme_info_favicon', __('Link favicon', 'gaumap'))->set_default_value('https://nrglobal.vn/wp-content/uploads/2018/06/favicon.png'),
						 Field::make('text', 'theme_info_website', __('Link favicon', 'gaumap'))->set_default_value('https://nrglobal.vn'),
						 Field::make('date', 'theme_info_date_started', __('Ngày bắt đầu thực hiện', 'gaumap')),
						 Field::make('date', 'theme_info_date_publish', __('Ngày bàn giao', 'gaumap')),
					 ]);
		});
	}
